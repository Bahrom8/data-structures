...
public class TestTree2App {
    public static void main(String[] args) {
        ...
        tree.printLeaves(tree.root);
        System.out.println("Height of root is: " + tree.height(tree.root.rightChild));
        System.out.println("Height of root is: " + tree.height(tree.root.leftChild.rightChild));
